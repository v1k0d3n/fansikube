...
echo "    3. Create rsa_keys and place them into ../rsa_keys with the command: 'ssh-keygen -t rsa -C "$server_name"-master@"$domain_name"'."
...
echo "         - Run ./prep-local-known-keys.sh to populate your ~/.ssh/known_hosts file with your "$server_name"-<host> information."
echo ""
...
echo ""
echo "  CONSIDERATIONS: "
echo "    * If you change default for the server_name (i.e. centos|fedora|ubuntu) then change them in inventory.ini as needed."
echo ""
echo " - v1k0d3n"
echo ""
